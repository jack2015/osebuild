...
/* pcscd filename */
#define PCSCD_BINARY "sysroot/usr/sbin/pcscd"

/* Enabled PC/SC lite features */
#define PCSCLITE_FEATURES " Linux arm-unknown-linux-androideabi serial usb libusb usbdropdir=/data/data/osebuild.cam/files/drivers ipcdir=/dev configdir=/data/data/osebuild.cam/files/reader.conf.d"

/* directory containing USB drivers */
#define PCSCLITE_HP_DROPDIR "/data/data/osebuild.cam/files/drivers"
